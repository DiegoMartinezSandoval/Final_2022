...
The null hypothesis has to be rejected since the chi-squared test states that the p-value is 0.00000000004812. This number is way below than the .05 mark. The chi-squared testGC also rejects the null hypothesis. It has a chi-squared statistic of 43.25 with a degrees of freedom of 1.  We reject the null hypothesis since it states that the p-value is 0. Also way below .05. The fisher exact test states that the p-value is 0.00000000002645. The fisher exact test also states that the odds ratio is 2.09 to 1. The 95% confidence interval  on the odds ratio is (1.67, 2.64). My alternative hypothesis states that the odds ratio is not equal to 1. Since all 3 p-values are below .05 & the odds ratio contradicts the null hypothesis, I can safely reject the null hypothesis. There is a difference, it being a beneficial one for males. 
...
(`r confIntLower`, `r confIntUpper`)%. The vaccine is effective on males since the percentage is greater than 50%. 
...
(`r confIntLower`, `r confIntUpper`)%. The vaccine is effective on females since the percentage is greater than 50%
...
(`r confIntLower`, `r confIntUpper`)%. The vaccine is disadvantageous for LGBTQ+ members since the percentage is less than 50%. 


### LGBTQ+ Discussion & Conclusion

The original question is if the vaccine is either beneficial, disadvantageous, or neutral in preventing LGBTQ+ members from contracting covid-19. I can conclude that there IS a difference. I can REJECT the null hypothesis. Since all 3 p-values were below .05 & since the odds ratio contradicts the null hypothesis. Now than, the vaccine NEGATIVELY effects LGBTQ+ members. The efficacy rate LGBTQ+ members is 13%. This is lower than 50% so it is disadvantageous for LGBTQ+ members. When LGBTQ+ members take the vaccine, their odds of contracting covid-19 INCREASES. Thus, I DON'T recommend that LGBTQ+ members take the vaccine since it doesn't help decrease their odds of contracting the deadly disease but instead, increase their odds of contracting it. 
...
(`r confIntLower`, `r confIntUpper`)%. The vaccine is disadvantageous for drug users since the percentage is less than 50%. 
